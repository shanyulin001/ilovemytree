  ...
  <div class="login">
    ...
    <form>
      ...
      <div>
        ...
        <input type="text" v-model='password' placeholder=" 输入验证码" />
    ...
    <button type="button" class="button" @click='zhuce'>确定</button>
    <img src="https://m.qpic.cn/psb?/5e5a306c-5484-411f-beba-13d0042de46f/XScjsMMo7xulqxdxQ85gHYDEgGJWAX*ji96wziqQFp4!/b/dL8AAAAAAAAA&bo=cwGXAAAAAAADB8c!&rf=viewer_4" alt="">
  </div>
</template>
<script>
